...
export const navLinkStyle =
  "font-semibold flex justify-center items-center h-14 p-2 space-x-2 rounded-lg hover:bg-slate-200 ";
export const links = [
  {
    label: "ilit",
    path: "/illit",

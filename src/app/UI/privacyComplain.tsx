export default function PrivacyComplain(){
	return(
		<div className="text-sm grid grid-rows-5 grid-flow-col divide-y divide-black divide-x border-b border-r border-black">
			<div className="font-semibold border-t border-l border-black p-3 col-span-2">개인정보책임자</div>

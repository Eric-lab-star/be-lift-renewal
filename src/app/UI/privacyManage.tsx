export default function PrivacyManage(){
	...
	return(
		<div className="dark:divide-zinc-300 dark:border-zinc-300 text-sm grid grid-cols-2 grid-flow-row divide-black divide-x divide-y border-b border-r border-black">
			...
			<div className="flex justify-center items-center p-1"> ㈜하이브</div> 
			<div className="flex justify-center items-center p-1"> 공연 및 오디션 운영 </div>
			<div className="flex justify-center items-center p-1">㈜인터파크 </div>
			<div className="flex justify-center items-center p-1">공연 티켓 판매 대행 및 티켓 구매자 확인 </div>
			<div className="flex justify-center items-center p-1">㈜메타넷엠씨씨 (재위탁) </div>
			<div className="flex justify-center items-center p-1">인터파크 공연 티켓 CS 운영 </div>
